...
### 5) Complex Strategy (Cost-Based Greedy / Turk-Style)
...
We splitted project into 3 parts:
- Classic operations like sa, sb, rr...
- Algorithms
- Checker

#### First Part
It was mostly done by memalli, since it wasn't a specializable category it was mostly repeatitive task.

#### Second Part
This part was the part with the selections, we splitted the work as 2-1 since don't want to get our works mix we decided to do algorithms seperatly and explain it peer to peer.

Simple Algorithm - Selection Sort - Made by memalli
Medium Algorithm - Chunk Based Sort - Made by alpturan
Complex Algorithm - Cost-Based Greedy(Turk Algorithm) Sort - Made by memalli

#### Third Part
Since checker was just a easy task we made it quickly. Mostly memalli did the coding part and alpturan test it.